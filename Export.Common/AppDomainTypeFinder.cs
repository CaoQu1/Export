...
namespace Export.Common
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether BangBang should iterate assemblies in the app domain when loading BangBang types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into BangBang.
        /// </returns>
